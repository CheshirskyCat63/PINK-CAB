...
void FPinkCabWorldSnapshotArchive::SerializeCityDeltaRecord(
    FArchive& Ar,
...
void FPinkCabWorldSnapshotArchive::SerializeWorldSnapshots(
    FArchive& Ar,
    FPinkCabCityDeltaSnapshot& CityDeltas,
    FPinkCabStateKernelSnapshot& Kernel,
    FPinkCabWorkdaySessionSnapshot& Workday)
{
    ...
    SerializeArray(
        Ar,
        Workday.AppliedHouseholdOperationIds,
        Workday.MaxReplayJournalEntries,

    ...
    const int32 Seed)
{
    ...
    F.Seed = Seed;
    F.ModelId = Profile.ModelId;
    F.ProfileId = Profile.ProfileId;
    F.ProfileSchemaVersion = Profile.SchemaVersion;
    F.CalibrationVersion = Profile.CalibrationVersion;
    ...
    const int32 InRunOrdinal)
{
    ...
    R.ModelId = Fixture.ModelId;
    R.ProfileId = Fixture.ProfileId;
    R.ProfileSchemaVersion = Fixture.ProfileSchemaVersion;
    R.CalibrationVersion = Fixture.CalibrationVersion;
    R.ProfileHash = Fixture.ProfileHash;
    R.VehicleMassKg = Fixture.VehicleMassKg;
    R.LoadStateId = Fixture.LoadStateId;
    R.SurfaceId = Fixture.SurfaceId;

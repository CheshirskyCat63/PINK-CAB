...
FPinkCabHandbrakeActuator::FPinkCabHandbrakeActuator(
...
void FPinkCabHandbrakeActuator::Reset(float InLeverPosition, bool bLatched)
{
...
float FPinkCabHandbrakeActuator::Step(
...
float FPinkCabHandbrakeActuator::GetLeverPosition() const
{
    return LeverPosition;
}

float FPinkCabHandbrakeActuator::GetBrakeCommand() const
{
    return BrakeCommand;
}

bool FPinkCabHandbrakeActuator::IsParkingLatched() const
{
    return bParkingLatched;
}

float FPinkCabHandbrakeActuator::EvaluateTorqueCommand(float Position) const
{
    return FMath::Pow(

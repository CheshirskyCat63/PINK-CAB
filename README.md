...
PRE-FGEAR work follows `CD-754` / `CD-755..CD-771`. PF-00 begins only after the dedicated-repository cut-over is closed with evidence. Use short-lived Jira-keyed branches; `main` is canonical integration.

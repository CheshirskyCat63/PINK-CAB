...
require_text "$registry" "status_counts: {locked: 93, calibration: 3, proposed_default: 78, open: 22}"
require_text "$registry" "numerator_points: 135.0"
require_text "$registry" "start90_percent: 68.9"
require_text "$registry" "start90_gate_passed: false"
require_text "$registry" "gap_to_start90_percentage_points: 21.1"
...
require_text docs/PINK_CAB_START90_READINESS.md "135.0 / 196 = 68.9%"

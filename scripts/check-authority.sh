...
require_text "$registry" "status_counts: {locked: 88, calibration: 3, proposed_default: 83, open: 22}"
require_text "$registry" "numerator_points: 132.5"
require_text "$registry" "start90_percent: 67.6"
require_text "$registry" "start90_gate_passed: false"
require_text "$registry" "gap_to_start90_percentage_points: 22.4"
...
require_text docs/PINK_CAB_START90_READINESS.md "132.5 / 196 = 67.6%"

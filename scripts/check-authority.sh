...
require_text "$registry" "status_counts: {locked: 99, calibration: 3, proposed_default: 72, open: 22}"
require_text "$registry" "numerator_points: 138.0"
require_text "$registry" "start90_percent: 70.4"
require_text "$registry" "start90_gate_passed: false"
require_text "$registry" "gap_to_start90_percentage_points: 19.6"
...
require_text docs/PINK_CAB_START90_READINESS.md "138.0 / 196 = 70.4%"

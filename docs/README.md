...
Technical Owner Pack 01: **196 rows = 45 LOCKED + 3 CALIBRATION + 88 PROPOSED DEFAULT + 60 OPEN**.

Scoring is reproducible: LOCKED/CALIBRATION = 1.0; PROPOSED DEFAULT = 0.5; OPEN = 0.0.

**Current code-only specification readiness = 46.9%. START-90 FAIL. Gap = 43.1 percentage points.**
...
If all 88 proposed defaults are owner-accepted, score becomes 69.4%; at least 41 of the 60 OPEN rows must then close to cross START-90 at 177/196 = 90.31%. Historical в‰€59% and 38.2% scores are retired.

...
The historical six-domain ≈59% figure is retired. Current code-only START-90 readiness is **66.6%** from the normalized 196-row Technical Owner Pack 01. Administrative authority hygiene is separate from unresolved owner decisions.
